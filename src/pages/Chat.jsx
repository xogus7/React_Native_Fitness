...
const dummy_chats = [
    ...
    },
    {
        ...
        image: 'https://avatar.iran.liara.run/public/',
        newMessageCount: 1,
        latestChatDate: new Date('2024-07-13'),
        latestMessage: 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNPOQRSTUVWXYZ',
    },
    {
        name: 'user3',
        image: 'https://avatar.iran.liara.run/public/boy',
        newMessageCount: 10,
        latestChatDate: new Date('2024-07-09'),
        latestMessage: '123456789012345678901234',
    },
    {
        name: 'user4',
        image: 'https://avatar.iran.liara.run/public/girl',
        newMessageCount: 301,
        latestChatDate: new Date('2024-07-10'),
        latestMessage: '일이삼사오육칠팔구십일이삼사오육칠팔구십일이삼사',
    },
];
